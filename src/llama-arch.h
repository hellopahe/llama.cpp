...
enum llm_tensor {
    ...
    LLM_TENSOR_A_ENC_EMBD_POS,
    LLM_TENSOR_A_ENC_ATTN_NORM,
    LLM_TENSOR_A_ENC_ATTN_Q,
    LLM_TENSOR_A_ENC_ATTN_K,
    LLM_TENSOR_A_ENC_ATTN_V,
    LLM_TENSOR_A_ENC_ATTN_OUT,
    LLM_TENSOR_A_ENC_FFN_NORM,
    LLM_TENSOR_A_ENC_FFN_GATE,
    LLM_TENSOR_A_ENC_FFN_DOWN,
    LLM_TENSOR_A_ENC_FFN_UP,
    LLM_TENSOR_CLS,
    LLM_TENSOR_CLS_OUT,
    LLM_TENSOR_CONV1D,
