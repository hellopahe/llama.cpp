...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_QWEN3OMNIMOE,
        {
            ...
            { LLM_TENSOR_FFN_DOWN_EXPS,      "blk.%d.ffn_down_exps" },
            { LLM_TENSOR_FFN_UP_EXPS,        "blk.%d.ffn_up_exps" },
            { LLM_TENSOR_A_ENC_EMBD_POS,     "audio_encoder.pos_embd" },
            { LLM_TENSOR_A_ENC_ATTN_NORM,    "audio_encoder.blk.%d.attn_norm" },
            { LLM_TENSOR_A_ENC_ATTN_Q,       "audio_encoder.blk.%d.attn_q" },
            { LLM_TENSOR_A_ENC_ATTN_K,       "audio_encoder.blk.%d.attn_k" },
            { LLM_TENSOR_A_ENC_ATTN_V,       "audio_encoder.blk.%d.attn_v" },
            { LLM_TENSOR_A_ENC_ATTN_OUT,     "audio_encoder.blk.%d.attn_output" },
            { LLM_TENSOR_A_ENC_FFN_NORM,     "audio_encoder.blk.%d.ffn_norm" },
            { LLM_TENSOR_A_ENC_FFN_GATE,     "audio_encoder.blk.%d.ffn_gate" },
            { LLM_TENSOR_A_ENC_FFN_DOWN,     "audio_encoder.blk.%d.ffn_down" },
            { LLM_TENSOR_A_ENC_FFN_UP,       "audio_encoder.blk.%d.ffn_up" },
        },
    },
    {
        LLM_ARCH_PHI2,
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_A_ENC_EMBD_POS,             {LLM_TENSOR_LAYER_INPUT, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_A_ENC_ATTN_NORM,            {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_A_ENC_ATTN_Q,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_ATTN_K,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_ATTN_V,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_ATTN_OUT,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_FFN_NORM,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_A_ENC_FFN_GATE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_FFN_DOWN,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_A_ENC_FFN_UP,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
